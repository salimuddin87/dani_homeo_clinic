...
class MedicineDetail(models.Model):
    ...
    count = models.CharField(max_length=2, default='', blank=True, null=True)
    date_of_mfg = models.DateField(blank=True, null=True)
    date_of_exp = models.DateField(blank=True, null=True)
    mrp = models.CharField(max_length=20, default='', blank=True, null=True)
    spr = models.CharField(max_length=20, default='', blank=True, null=True)
