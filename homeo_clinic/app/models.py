...
class PatientDetail(models.Model):
    ...
    past_history = models.CharField(max_length=500, blank=True, null=True)
    family_history = models.CharField(max_length=500, blank=True, null=True)
    generalities = models.CharField(max_length=500, blank=True, null=True)
    on_examination = models.CharField(max_length=500, blank=True, null=True)
    lab_reports = models.CharField(max_length=500, blank=True, null=True)
